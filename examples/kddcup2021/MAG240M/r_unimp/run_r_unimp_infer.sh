CUDA_VISIBLE_DEVICES=0,1,2 python -m paddle.distributed.launch --log_dir ./output/model_64_valid_0/ r_unimp_multi_gpu_infer.py --conf configs/r_unimp_m2v_64_0.yaml --do_eval
